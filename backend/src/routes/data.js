...
router.get('/panel', async (req, res) => {
  ...
  const COLS = [
    ...
    'doe_econ_dis_count', 'doe_free_meals_count', 'doe_reduced_price_count',
    'doe_english_learner_count',
    'doe_swd_count',
    'doe_swd_autism_count', 'doe_swd_emotional_count', 'doe_swd_intellectual_count',
    'doe_swd_learning_count', 'doe_swd_other_count', 'doe_swd_other_health_count',
    'doe_swd_speech_count',
